(function() {
  ...
  var CountryISOService = function() {
    var self = {
      countries: [
        {'ccode': '', 'cname': 'Show All'},
      ...
      getCountryName: function(isoCode) {
        if(self.countriesWithISO.hasOwnProperty(isoCode)) {
          return self.countriesWithISO[isoCode];
        }
        return isoCode;
      }
    };
  ...
  angular.module("app").service("CountryISOService", CountryISOService);
